...
const CSRPage = () => {
  return (
    ...
    <section className="bg-white text-center pt-10 md:pt-15 px-10  ">
        {/* Title */}
        <h2 className="font-prata text-2xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-5">
          Our Programs
        </h2>
      ...
      <section className=" bg-white pt-10 md:pt-15 px-10 ">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          ...
          <div className="order-2 md:order-1 space-y-6 text-center md:text-left">
            <h2 className="font-prata text-2xl sm:text-2xl md:text-3xl lg:text-4xl font-bold md:text-left text-center">
              Our Impact
            </h2>
