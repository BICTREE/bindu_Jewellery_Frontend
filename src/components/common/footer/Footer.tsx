...
<div className="container">
  ...
  <div className=" mx-auto px-4 py-12">
    ...
    <div className="grid grid-cols-1 md:grid-cols-[1fr_2.5fr] gap-10">
      ...
      <div className="flex flex-col items-center text-left">
        ...
        {/* ✅ Centered App Store & Play Store on mobile */}
  ...
  <div className="bg-gray-900 py-4 px-4 ">
    <div className="container mx-auto flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 text-left">
